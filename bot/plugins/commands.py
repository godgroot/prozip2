...
async def start(bot, update):
                    ...
                    [
                        [
                            InlineKeyboardButton
                                (
                                    '🔔Join Main Channel🔔', url=f"{CINEMAZIPLINKS}"
                                )
                        ],
                        [
                            InlineKeyboardButton
                                (
                                    '🔊 Bot Updates 🔊', url=f"{CINEMAZIP}"
                                )
                        ]
                    ]
                )
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton
                                (
                                    '🔱 JOIN 🔱', url="https://t.me/CINEMAZIPLINKS"
                                )
                        ]
                    ]
                )
    ...
    buttons = [[
        InlineKeyboardButton('👨‍💼Creater', url=f'https://t.me/{IM_GODGROOT}'),
        InlineKeyboardButton('Help 🤔', callback_data="help")
    ],[
        InlineKeyboardButton('🗣️Group', url=f'{cinemazip}'),
        InlineKeyboardButton('Channel🔊', url=f'{cinemaziplinks}')
    ],[
        InlineKeyboardButton('🖥️ Tutorial Video 🖥️', url='https://t.me/CINEMAZIP')
    ]]
...
async def about(bot, update):
    ...
    buttons = [[
        InlineKeyboardButton('👤 Ashaan👤', url='https://t.me/IM_GODGROOT'),
        InlineKeyboardButton('Skp KP👤', url='https://t.me/Skp_Kp')
    ],[
        InlineKeyboardButton('👤 GOD 👤', url='https://t.me/cinemazipnews')
    ],[
